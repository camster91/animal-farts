...
export const SCENES: Scene[] = [
  {
    ...
    things: [
      ...
      { id: 'duck',    emoji: '🦆', name: 'Duck',    x: 22, y: 82, size: 10, sounds: ['/sounds/duck.mp3', '/sounds/v1/duck.mp3'] },
      { id: 'rooster', emoji: '🐓', name: 'Rooster', x: 75, y: 22, size: 11, sounds: ['/sounds/rooster.mp3', '/sounds/v1/rooster.mp3'] },
      { id: 'tractor', emoji: '🚜', name: 'Tractor', x: 88, y: 78, size: 12, sounds: ['/sounds/extra/bull.mp3'] },
      { id: 'barn',    emoji: '🚪', name: 'Barn',    x:  8, y: 52, size: 11, sounds: ['/sounds/extra/cat.mp3'] },
      { id: 'hay',     emoji: '🌾', name: 'Hay',     x: 50, y: 80, size:  9, sounds: ['/sounds/extra/monkey_v2.mp3'] },
      { id: 'dog',     emoji: '🐕', name: 'Dog',     x: 42, y: 35, size: 10, sounds: ['/sounds/dog.mp3', '/sounds/extra/dog_v2.mp3'] },
      { id: 'owl',     emoji: '🦉', name: 'Owl',     x: 12, y: 18, size:  9, sounds: ['/sounds/extra/owl.mp3'] },
    ],
  },
];
