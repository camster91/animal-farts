...
export const PRESETS: FartPreset[] = [
  // Original 12 — kept exactly as v4
  {
    id: "cow", name: "Cow", emoji: "🐄", color: "from-pink-200 to-pink-400",
    src: "/sounds/cow.mp3", pitchShift: -2, rate: 0.9, caption: "MOOO-TION TOOT",
  ...
  },
  {
    ...
    src: "/sounds/dog.mp3", pitchShift: 0, rate: 1.0, caption: "SQUEAKY TOOT",
  ...
  },
  {
    ...
    src: "/sounds/cat.mp3", pitchShift: 1, rate: 1.05, caption: "PURR-TOOT",
  ...
  },
  {
    ...
    src: "/sounds/bird.mp3", pitchShift: 2, rate: 1.1, caption: "TWEET-TOOT",
  ...
  },
  {
    ...
    src: "/sounds/horse.mp3", pitchShift: -3, rate: 0.85, caption: "THUNDER PLOP",
  ...
  },
  {
    ...
    src: "/sounds/pig.mp3", pitchShift: 0, rate: 0.95, caption: "OINK-OINK TOOT",
  ...
  },
  {
    ...
    src: "/sounds/duck.mp3", pitchShift: 1, rate: 1.0, caption: "QUACK-TOOT",
  ...
  },
  {
    ...
    src: "/sounds/elephant.mp3", pitchShift: -4, rate: 0.8, caption: "ROLLING THUNDER",
  ...
  },
  {
    ...
    src: "/sounds/monkey.mp3", pitchShift: 0, rate: 1.0, caption: "BEAT DROP",
  ...
  },
  {
    ...
    src: "/sounds/snake.mp3", pitchShift: 1, rate: 1.1, caption: "BURP-N-FART",
  ...
  },
  {
    ...
    src: "/sounds/lion.mp3", pitchShift: -1, rate: 0.95, caption: "ROAR-TOOT",
  ...
  },
  {
    ...
    src: "/sounds/frog.mp3", pitchShift: 2, rate: 1.1, caption: "RIBBIT TOOT",
  ...
  // New animals (additive)
  {
    ...
    src: "/sounds/bull.mp3", pitchShift: -3, rate: 0.85, caption: "ROARIN' BULL",
    loopable: false, baseFreq: 55, detune: 8, attack: 0.05, hold: 0.85, release: 0.6,
  ...
  },
  {
    ...
    src: "/sounds/rabbit.mp3", pitchShift: 4, rate: 1.2, caption: "TINY TOOT",
    loopable: false, baseFreq: 380, detune: 4, attack: 0.005, hold: 0.12, release: 0.1,
    cutoff: 3000, noise: 0.1, pitchSweep: -8, wobble: 2, wobbleRate: 4, squelch: 0, thump: false,
  },
  {
  ...
  },
  {
    ...
    src: "/sounds/rooster.mp3", pitchShift: 2, rate: 1.1, caption: "COCK-A-DOODLE",
  ...
  },
  {
    ...
    src: "/sounds/turtle.mp3", pitchShift: -1, rate: 0.9, caption: "SLOW & LOW",
  ...
  },
  {
    ...
    src: "/sounds/whale.mp3", pitchShift: -6, rate: 0.7, caption: "WHALE SONG",
