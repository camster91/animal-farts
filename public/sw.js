...
const CACHE = "poot-party-v29-errors-100pct";
...
const SHELL_ASSETS = [
  ...
  // v25w2: scene illustrations (generated by minimax image gen).
  // Small JPEGs (~150-350KB each, 1.3MB total). Precache so the kid
  // sees the scene background on first load.
  "/scenes/farm.jpg",
  "/scenes/jungle.jpg",
  "/scenes/ocean.jpg",
  "/scenes/city.jpg",
  ...
  "/scenes/bathroom.jpg",
  "/scenes/home.jpg",
  // v29: self-hosted Fredoka (privacy, COPPA)
